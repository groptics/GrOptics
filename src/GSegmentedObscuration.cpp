...
SegmentedObscuration::SegmentedObscuration(Double_t rmin, Double_t rmax,
...
//______________________________________________________________________________
TGeoCombiTrans* SegmentedObscuration::BuildObscurationCombiTrans(AGeoAsphericDisk* disk, Bool_t isPrimary)
{
...
//______________________________________________________________________________
void SegmentedObscuration::SetMargin(Double_t margin)
{
...
//______________________________________________________________________________
void SegmentedObscuration::SetPositionErrors(Double_t x, Double_t y, Double_t z)
{
...
//______________________________________________________________________________
void SegmentedObscuration::SetRotationErrors(Double_t xy, Double_t sag, Double_t tan)
{
...
SectorSegmentedObscuration::SectorSegmentedObscuration(Double_t rmin, Double_t rmax, Double_t phimin, Double_t phimax)
  : SegmentedObscuration(rmin, rmax, phimin, phimax) {

};
//______________________________________________________________________________
AObscuration* SectorSegmentedObscuration::BuildObscuration(const char* name,
                                            ...
                                            Bool_t isPrimary)
{
  ...
  AObscuration* obscuration = new AObscuration(Form("%s_obscuration", name), comp);
  
  return obscuration;
}

//______________________________________________________________________________
TetragonSegmentedObscuration::TetragonSegmentedObscuration(Double_t rmin, Double_t rmax, Double_t phimin, Double_t phimax) :
  SegmentedObscuration(rmin, rmax, phimin, phimax)
{
}

//______________________________________________________________________________
AObscuration* TetragonSegmentedObscuration::BuildObscuration(const char* name,
                                              AGeoAsphericDisk* disk,
                                              Bool_t isPrimary)
{
  Double_t zmin = disk->GetOrigin()[2] - disk->GetDZ();
...
//______________________________________________________________________________
PentagonSegmentedObscuration::PentagonSegmentedObscuration(Double_t rmin, Double_t rmax, Double_t phimin, Double_t phimax) :
  SegmentedObscuration(rmin, rmax, phimin, phimax)
{
}

//______________________________________________________________________________
AObscuration* PentagonSegmentedObscuration::BuildObscuration(const char* name,
                                              AGeoAsphericDisk* disk,
                                              Bool_t isPrimary)
{
  Double_t zmin = disk->GetOrigin()[2] - disk->GetDZ();
